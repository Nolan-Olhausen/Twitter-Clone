 ...
 *
 * @brief:
 *      This file is the explore page. It displays posts from users at random in a grid format.
 *
 ****************************************************************************************************/
-->
...
<?php 
    ...
    $posts = $dao->explorePosts($user_id);
...
<html>
    ...
    <body>
        ...
        <div class="feed">
            ...
            <div class="explorePosts">
                <?php include 'explorePostsGrid.php'; ?>
            </div>
