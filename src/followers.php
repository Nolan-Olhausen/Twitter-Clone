 ...
 *
 * @brief:
 *      This is the front end for the followers page. It displays the followers of a user.
 *
 ****************************************************************************************************/
-->
...
<?php 
    ...
    $uResults = $dao->usersFollowers($profileId);
?>
            ...
            <div class="followingposts">
                <div class="feedInner">
                    <div class="feedHeader">
                        <h2><?php echo $profileData->username; ?>'s Followers</h2>
                    </div>
                </div>
                <?php
