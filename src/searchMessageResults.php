...
/****************************************************************************************************
 *
 * @file:    searchMessageResults.php
 * @author:  Nolan Olhausen
 * @date: 2024-04-5
 *
 * @brief:
 *      This is the front end for the search message results. It displays the messages that match the search.
 *
 ****************************************************************************************************/
-->
...
<?php 
    ...
    $mResults = $dao->getChats($user_id,$_GET['search']);
?>
